...
function DualIslandPage() {
  const dualIslandIframeUrl = import.meta.env.VITE_DUAL_ISLAND_IFRAME_URL || '/dual-island/';
  ...
  return (
    <div className="fixed inset-0 z-0 bg-black flex flex-col" style={{ paddingBottom: playerOffset }}>
      <div
        className="hidden md:flex items-center justify-between px-4 py-3 border-b border-white/10 bg-black/60 backdrop-blur-lg"
      ...
      <div className="flex-1 min-h-0 relative">
        <iframe
          title="Dual Island"
          src={dualIslandIframeUrl}
          className="absolute inset-0 w-full h-full border-0"
          allow="fullscreen; clipboard-read; clipboard-write"
        />
      </div>
      <div
        className="md:hidden flex items-center justify-between gap-3 px-4 py-3 border-t border-white/10 bg-black/70 backdrop-blur-lg"
