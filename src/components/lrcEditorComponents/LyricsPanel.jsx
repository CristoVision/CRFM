    ...
    return (
      <div className="w-full md:w-1/2 flex flex-col overflow-hidden" ref={ref}>
        <div className="flex justify-between items-center mb-2 px-1">
          <div className="flex items-center gap-2">
            ...
            <Popover>
              ...
              <PopoverContent
                className="w-auto p-3 glass-effect text-xs text-gray-200 border-white/20"
                side="bottom"
                align="start"
              >
                <p className="font-semibold mb-1 golden-text">Desktop Shortcuts:</p>
                <p>
                  <strong className="text-yellow-300">Spacebar:</strong> Sync current line
                </p>
                <p>
                  <strong className="text-yellow-300">Backspace:</strong> Go to previous line
                </p>
                <p>
                  <strong className="text-yellow-300">Enter (in lyric input):</strong> Sync line
                </p>
        ...
        >
            ...
            <div className="text-center py-10">
              ...
              <Textarea
                ...
                onBlur={(e) => {
                  ...
                  const parsed = parseLrcTextToLines(newRawLyrics, true);
                  setLyrics(parsed);
          ...
          {lyrics.map((line, index) => (
            <div
              ...
              className={`p-2 rounded-md flex items-center gap-2 transition-all duration-150 ${
        ...
        <div className="mt-2 flex items-center justify-between px-1">
          <Button
            onClick={() => addLyricLine(lyrics.length > 0 ? lyrics.length - 1 : 0)}
            size="sm"
            variant="outline"
            className="text-xs"
          >
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              className="form-checkbox h-4 w-4 text-yellow-400 bg-gray-700 border-gray-600 rounded focus:ring-yellow-500"
            />
            <label htmlFor="autoAdvance" className="text-xs text-gray-300">
              Auto-Advance
            </label>
          </div>
        </div>
