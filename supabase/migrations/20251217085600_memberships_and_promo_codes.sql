...
begin
  ...
  if not exists (select 1 from pg_policies where policyname = 'creator_membership_tiers_select_active') then
  ...
  if not exists (select 1 from pg_policies where policyname = 'creator_membership_tiers_select_admin') then
  ...
  if not exists (select 1 from pg_policies where policyname = 'creator_membership_tiers_creator_insert') then
  ...
  if not exists (select 1 from pg_policies where policyname = 'creator_membership_tiers_creator_update') then
  ...
  if not exists (select 1 from pg_policies where policyname = 'creator_memberships_select_self_or_creator_or_admin') then
  ...
  if not exists (select 1 from pg_policies where policyname = 'creator_memberships_admin_update') then
  ...
  if not exists (select 1 from pg_policies where policyname = 'promo_codes_admin_select') then
    create policy promo_codes_admin_select on public.promo_codes
      for select using (is_admin_uid(auth.uid()));
  end if;
  if not exists (select 1 from pg_policies where policyname = 'promo_codes_admin_insert') then
    create policy promo_codes_admin_insert on public.promo_codes
      for insert with check (is_admin_uid(auth.uid()));
  end if;
  if not exists (select 1 from pg_policies where policyname = 'promo_codes_admin_update') then
  ...
  if not exists (select 1 from pg_policies where policyname = 'promo_code_redemptions_select_self_or_admin') then
  ...
  if not exists (select 1 from pg_policies where policyname = 'wallet_code_redemptions_select_self_or_admin') then
    create policy wallet_code_redemptions_select_self_or_admin on public.wallet_code_redemptions
      for select using (auth.uid() = user_id or is_admin_uid(auth.uid()));
  end if;
  if not exists (select 1 from pg_policies where policyname = 'billing_events_select_self_or_admin') then
